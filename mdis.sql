...
CREATE TABLE `tbl_master_absensi` (
`id` INT( 11 ) NOT NULL AUTO_INCREMENT PRIMARY KEY ,
`hari_kerja` VARCHAR( 50 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`jam_masuk` CHAR( 50 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`jam_pulang` CHAR( 50 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE = MYISAM ;
